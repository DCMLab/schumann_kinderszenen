...
* `Robert Schumann – Kinderszenen <https://github.com/DCMLab/schumann_kinderszenen/archive/refs/heads/main.zip>`__


Data Formats
============

Each piece in this corpus is represented by four files with identical names, each in its own folder. For example, the first piece has the following files:
...
For questions, remarks etc., please `create an issue <https://github.com/DCMLab/schumann_kinderszenen/issues>`__ and feel free to fork and submit pull requests.
